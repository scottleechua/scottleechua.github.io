...
6. Add, commit, then push this first set of changes to GitHub. (For an introduction to GitHub, see [here](https://swcarpentry.github.io/git-novice/).) At this stage, your folder structure should look like:
    ```
    .
    └── my-script-repo/
        ├── .gitignore
